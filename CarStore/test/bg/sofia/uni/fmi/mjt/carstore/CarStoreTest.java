...
import static bg.sofia.uni.fmi.mjt.carstore.TestConstants.*;
...
public class CarStoreTest {
    ...
    @Test
    public void testIfNewCarIsAddedSuccessfully(){
    ...
    public void testIfTheSameCarFailsToBeAdded() {
        Car one = new SportsCar(Model.AUDI, CAR_OLD_YEAR, EXPENSIVE_CAR_PRICE, EngineType.DIESEL, Region.BURGAS);
